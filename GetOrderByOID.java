...
public class GetOrderByOID implements HttpRequestHandler {

	public static Logger log = Logger.getLogger(GetOrderByOID.class);
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		try {
			...
			List<Order> orders= dao.getOrderByOID(orderID);
//			for(Order or:orders) {
