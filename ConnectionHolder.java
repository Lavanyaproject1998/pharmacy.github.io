...
public class ConnectionHolder {
	...
	private void initAppDataSource() throws DBConnectionException {
		Context initContext;  // It will read context.xml 

		try {
			initContext = new InitialContext();
			Context envContext = (Context) initContext.lookup("java:/comp/env");  // JNDI Search 
			ds = (DataSource) envContext.lookup("jdbc/pharmacystore");
